...
def insert_dataVehRoute(connection, raggruppa, scelta):
    try:
        cursor = connection.cursor()
...
def insert_dataSummary(connection, raggruppa, scelta):
    try:
        cursor = connection.cursor()
...
def trunkTables(connection, scelta):
...
def creaDatabase(scelta):
    ...
    trunkTables(connection, scelta)
    updateLogs(connection)
    ...
    for elemento in lista.findall('vehicle'):
        ...
        insert_dataVehRoute(connection, raggruppa, scelta)
    ...
    for elemento in lista.findall('step'):
        ...
        if tempo%120==0:
            ...
            insert_dataSummary(connection, raggruppa, scelta)
